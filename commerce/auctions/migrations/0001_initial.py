# Generated by Django 3.2.9 on 2021-12-31 18:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_status', models.CharField(choices=[('OPEN', 'avaliable'), ('CLOSED', 'unavaliable')], default='OPEN', max_length=6)),
                ('item_image', models.URLField(max_length=300)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('item_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.listing')),
            ],
        ),
        migrations.CreateModel(
            name='Bid',
